...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'withdrawDetail', component: _import('report/withdrawDetail'), name: 'withdrawDetail', meta: { title: '用户提现明细', noCache: true }},
      { path: 'customeraccountcheck', component: _import('report/customerAccountCheck'), name: 'timesale', meta: { title: '存储金对账明细', noCache: true }}

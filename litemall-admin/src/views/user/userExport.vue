<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      ...
      <el-select clearable class="filter-item" style="width: 200px;" v-model="listQuery.isBuys" filterable placeholder="请选择消费类别">
        <el-option label="已消费" value="yes">
        </el-option>
        <el-option label="未消费" value="no">
        </el-option>
      </el-select>
      <el-select clearable class="filter-item" style="width: 200px;" v-model="listQuery.userLevel" filterable placeholder="请选择用户等级">
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" min-width="100px" label="积分" prop="point">
      </el-table-column>

      <el-table-column align="center" min-width="100px" label="消费类别" prop="isBuys">
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" ref="dataForm" :model="dataForm" status-icon label-position="left" label-width="100px" style='width: 400px; margin-left:50px;'>
        ...
        <el-form-item label="积分" prop="point">
          <el-input v-model="dataForm.point"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['用户名', '手机号码', '性别', '生日','用户等级','消费类别', '状态']
        const filterVal = ['username', 'mobile', 'gender', 'birthday', 'userLevel', 'isBuys', 'status']

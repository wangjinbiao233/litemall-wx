<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-input clearable class="filter-item" style="width: 200px;" placeholder="请输入昵称" v-model="listQuery.userName">
      </el-input>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['用户ID', '用户昵称', '搜索历史关键字', '添加时间']
        const filterVal = ['userId', 'userName', 'keyword', 'addTime']

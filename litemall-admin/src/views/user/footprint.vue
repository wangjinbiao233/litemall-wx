<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      ...
      <el-input clearable class="filter-item" style="width: 200px;" placeholder="请输入商品名称" v-model="listQuery.goodName">
      </el-input>
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" min-width="100px" label="用户昵称" prop="userName">
      </el-table-column>
    ...
    methods: {
      ...
      handleDownload() {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          const tHeader = ['用户昵称', '商品名称', '添加时间']
          const filterVal = ['userName', 'goodName', 'addTime']
          excel.export_json_to_excel2(tHeader, this.list, filterVal, '用户足迹信息')

...
public class LitemallGoodsService {
    ...
    public List<LitemallGoods> querySelective(String goodsSn, String name, Integer categoryId, Integer page, Integer size, String sort, String order) {
        LitemallGoodsExample example = new LitemallGoodsExample();
        LitemallGoodsExample.Criteria criteria = example.createCriteria();
    ...
    public int countSelective(String goodsSn, String name, Integer categoryId, Integer page, Integer size, String sort, String order) {
        LitemallGoodsExample example = new LitemallGoodsExample();
        LitemallGoodsExample.Criteria criteria = example.createCriteria();
	...
	public List<LitemallGoods> querySelectiveForStore(LitemallGoods goods, Integer page, Integer limit, String sort,
			String order) {
		   PageHelper.startPage(page, limit);
		return goodsMapper.selectSelectiveForStore(goods);
	}

	public int countForStore(LitemallGoods goods, Integer page, Integer limit, String sort, String order) {
	
		return goodsMapper.selectCountForStore(goods);
	}
	
	 public List<LitemallGoods> queryByHotCategory(int offset, int limit,Integer categoryId) {
//	        LitemallGoodsExample example = new LitemallGoodsExample();
//	        example.or().andCategoryIdEqualTo(categoryId).andIsHotEqualTo(true).andDeletedEqualTo(false);
//	        PageHelper.startPage(offset, limit);

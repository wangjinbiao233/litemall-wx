...
public class LitemallCategoryService {
    ...
    public List<LitemallCategory> querySelectiveByParentId(String parentId, String sort, String order) {
        LitemallCategoryExample example = new LitemallCategoryExample();
        LitemallCategoryExample.Criteria criteria = example.createCriteria();
        criteria.andDeletedEqualTo(false);
...
//            return categoryMapper.selectByExample(example);
//        } else {
//            return new ArrayList<LitemallCategory>();
//        }
	...
	public List<LitemallCategory> queryCategoryValid() {
		return categoryMapper.queryCategoryValid();
	}
}

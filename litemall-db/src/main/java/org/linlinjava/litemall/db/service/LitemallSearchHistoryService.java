...
public class LitemallSearchHistoryService {
	...
	public Map<String, Object> querySelective(LitemallSearchHistory history, Integer page, Integer limit, String sort,
			String order) {
		Map<String, Object> data = new HashMap<>();
		PageHelper.startPage(page, limit);
		List<LitemallSearchHistory> list = searchHistoryMapper.selectByHistory(history);
        PageInfo<LitemallSearchHistory> pageInfo = new PageInfo<>(list);

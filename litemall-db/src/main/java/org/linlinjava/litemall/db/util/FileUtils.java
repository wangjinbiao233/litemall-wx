...
public class FileUtils {
    ...
    public static final String PATH_SRCEENTSHOT = "screenshot";
     ...
     * @return
     */
	public static File getMp4OutputByFilename(File input, String output_filename) {
		return new File(input.getParent() + File.separator + output_filename + EXTEND_MP4);
	}
    /**
     * 创建目录
     *
